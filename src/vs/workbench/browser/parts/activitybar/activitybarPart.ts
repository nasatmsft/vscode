...
export class ActivityBarCompositeBar extends PaneCompositeBar {
	...
	constructor(
		...
		super(location,
			...
			}, part, paneCompositePart, instantiationService, storageService, extensionService, viewDescriptorService, viewService, contextKeyService, environmentService, layoutService, menuService);
